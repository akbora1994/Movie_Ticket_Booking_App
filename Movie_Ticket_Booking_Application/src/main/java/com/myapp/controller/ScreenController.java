...
import com.myapp.service.ScreenService;
...
public class ScreenController {
	...
	public ResponseEntity<Screen> addScreenToTheatreHandler(@Valid @RequestParam("theaterId") Integer theaterId,
				@NotNull(message = "ScreenName shouldn't be null")	@RequestParam("screenName") String screenName) throws ScreenException {
	...
	public ResponseEntity<Screen> addSeatsToScreenHandler(
		    ...
		    @Min(value = 1,message = "Seat price cannot be negative/zero") @RequestParam("seatPrice") Double seatPrice) throws ScreenException {
